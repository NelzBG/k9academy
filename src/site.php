...
$strings = [
    'bg' => [
        ...
        'quick_contact_copy' => 'Оставете кратко запитване. Ще обсъдим темперамента, средата и целите ви, преди да предложим посока.',
    ...
    'en' => [
        ...
        'quick_contact_copy' => 'Send a short enquiry. We will discuss temperament, environment and goals before suggesting a direction.',
        'form_name' => 'Your name',
        'form_phone' => 'Phone',
        'form_email' => 'Email',
