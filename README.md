...
The release uses contactMode: direct in src/production.json. Phone and Viber use +359 892 360 550, Messenger opens m.me/k9academybg, and email opens mail.k9shop@gmail.com. WhatsApp has been replaced by calling with a custom generated icon. Online enquiries remain inactive: the NextGen public endpoint is challenged by SiteGround, and inbox receipt still needs confirmation. To enable online mode, configure the confirmed recipient and tested HTTPS endpoint and verify mailbox delivery. Public configuration contains no credentials.
